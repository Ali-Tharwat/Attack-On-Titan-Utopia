...
import game.gui.model.wallView;
 ...
 public class StartHard  extends Start{
	...
	public StartHard() throws IOException{
		 battle  = new Battle(1,0,2000,5,125) ;
		selectedLaneIndex = 3;
	...
	// will be needed in weaponShop
	 public Lane getLaneFromIndex(int selectedIndex) throws InvalidLaneException {
	        switch (selectedIndex) {
	            ...
	            case 4:
	                return laneViews.get(3).getLane();
	            case 5:
	                return laneViews.get(4).getLane();
	            default:
    ...
    private VBox createLanesView() {
       ...
       lanesBox.setTranslateX(-10);
        ...
        for (Lane lane : battle.getLanes()) {
            laneView laneView = new laneView(lane,5.1/3, battle.getTitanSpawnDistance());
